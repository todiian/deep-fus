...
%%%%%
n = 1;
rf_datain{n} = '/media/todiian/verasonics_storage/todiian/Data/20190815T162038_v1';
processed_datain{n} = '/media/todiian/verasonics_storage/todiian/Data/20190815T162038_v1_processed';
save_str{n} = '20190815T162038';

n = 2;
rf_datain{n} = '/media/todiian/verasonics_storage/todiian/Data/20190815T163300_v1';
processed_datain{n} = '/media/todiian/verasonics_storage/todiian/Data/20190815T163300_v1_processed';
save_str{n} = '20190815T163300';

n = 3;
rf_datain{n} = '/media/todiian/verasonics_storage/todiian/Data/20191205T152341_v1';
processed_datain{n} = '/media/todiian/verasonics_storage/todiian/Data/20191205T152341_v1_processed';
save_str{n} = '20191205T152341';

n = 4;
rf_datain{n} = '/media/todiian/verasonics_storage/todiian/Data/20191205T155708_v1';
processed_datain{n} = '/media/todiian/verasonics_storage/todiian/Data/20191205T155708_v1_processed';
save_str{n} = '20191205T155708';
...
%             zcrop_start = [1 n_z-n_pix round((n_z-n_pix)/2)];
            ...
            % Define x,z coordinates for 1 crop [center along z]
            xcrop_start = [1];
            zcrop_start = [round((n_z-n_pix)/2)];
        end
...
%             zcrop_start = [1 1 1];
            ...
            % Define x,z coordinates for 1 crop [center along x]
            xcrop_start = [round((n_x-n_pix)/2)];
            zcrop_start = [1];
        end
...
%             zcrop_start = [1 1 n_z-n_pix n_z-n_pix round((n_z-n_pix)/2)];
            ...
            % Define x,z coordinates for 1 crop [center along x and z]
            xcrop_start = [round((n_x-n_pix)/2)];
            zcrop_start = [round((n_z-n_pix)/2)];
        end
