...
Pre-trained models are available [here](https://doi.org/10.6084/m9.figshare.23663979.v1). Download the 'pretrained_models' folder containing the .h5 files and copy it in the 'deep-fus' folder. Use one of these models to reconstruct the power Doppler images stored in [data/test](data/test).
